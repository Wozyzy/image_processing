...
print("Veri dönüşümü ayarlanıyor...")
...
for epoch in range(3):
    ...
    for batch_idx, (inputs, labels) in enumerate(trainloader):
        ...
        if batch_idx % 20 == 0:
            print(f"  Batch {batch_idx}/{len(trainloader)} | Anlık Loss: {loss.item():.4f}")
    ...
    print(f"Epoch {epoch+1} tamamlandı - Loss: {avg_loss:.4f} | Accuracy: {acc:.2f}%\n")
